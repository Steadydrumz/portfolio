      ...
      <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
        ...
        <div className="flex justify-center gap-5 mb-16 animate-slide-up delay-500">
          {[
            ...
            { id: 'linkedin', url: 'https://linkedin.com/in/yourusername', color: 'text-[#4f46e5]', path: 'M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2zM4 4a2 2 0 1 1 0 4 2 2 0 0 1 0-4z' },
